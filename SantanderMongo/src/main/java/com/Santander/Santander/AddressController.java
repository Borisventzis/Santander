...
public class AddressController {
	...
	public String ObtenerDatos(Model model) {
	 ...
	 @RequestMapping("/newAddress") public String newAddress(Address address ,Model model) {
	  ...
	  public String EliminarDireccion(@RequestParam("DireccionEliminar") String dni, Model model) {
	  ...
	  public String Update(@PathVariable("DireccionActualizar") String dni ,Address address ,Model model) {
